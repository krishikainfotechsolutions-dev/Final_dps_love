            ...
            {sorted.map((k: any) => (
              ...
              >
                ...
                <div className="rounded-2xl p-5 bg-card border shadow-card hover-lift">
                  <span className="inline-block text-[10px] font-bold uppercase tracking-wider px-2 py-0.5 rounded bg-gold/20 text-primary mb-2">
                    {k.type}
                  </span>
                  <div className="flex items-start justify-between gap-2">
                    ...
                    {k.link && k.link.trim() !== "" && (
                      <a
                        ...
                        aria-label={`More details about ${k.title}`}
                      >
