...
import { cldOptimized, cldSrcSet, cldPlaceholder } from "@/lib/cloudinary";
            ...
            return (
              ...
              >
                <img
                  ...
                  srcSet={cldSrcSet(thumb, [480, 900, 1200])}
                  sizes="(max-width: 640px) 100vw, (max-width: 1024px) 50vw, 33vw"
                  alt={g.title}
                  loading="lazy"
                  decoding="async"
                  style={{ backgroundImage: `url(${cldPlaceholder(thumb)})`, backgroundSize: "cover" }}
