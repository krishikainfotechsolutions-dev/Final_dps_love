        ...
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-14 items-center mt-2">
          ...
          >
            ...
            <p className="mt-5 text-muted-foreground leading-relaxed">
              For over three decades, Dehradoon Public Senior Secondary School has been a place where every child is seen, heard and inspired. We blend academic rigour with creativity, character and care — preparing students to thrive in a rapidly evolving world.
            </p>
