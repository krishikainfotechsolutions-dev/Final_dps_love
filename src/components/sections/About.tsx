...
export default function About() {
  ...
  return (
    ...
    >
      {/* Background: static on mobile (cheaper paint), photo + gradient on desktop */}
      ...
      <div className="container mx-auto px-4 relative">
        ...
        <motion.div
          variants={stagger(lowMotion ? 0 : 0.1, lowMotion ? 0.04 : 0.1)}
          initial="hidden"
          whileInView="show"
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <motion.div
            ...
            whileInView="show"
            viewport={viewportOnce}
            className="rounded-3xl p-8 bg-gradient-to-br from-primary to-primary-glow text-primary-foreground shadow-elegant"
          >
          ...
          <motion.div
            ...
            whileInView="show"
            viewport={viewportOnce}
            className="rounded-3xl p-8 glass shadow-card"
          >
