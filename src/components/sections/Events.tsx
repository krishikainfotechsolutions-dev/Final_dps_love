  ...
  return (
    <section id="events" className="relative py-24 scroll-mt-24">
      <div className="container mx-auto px-4">
        ...
        <motion.div variants={stagger(0.05, 0.08)} initial="hidden" whileInView="show" viewport={viewportOnce} className="flex gap-5 overflow-x-auto no-scrollbar pb-6 snap-x snap-mandatory px-2 items-center">
          {events.map((e: any) => (
            <motion.button
              key={e.id}
              variants={fadeUp}
