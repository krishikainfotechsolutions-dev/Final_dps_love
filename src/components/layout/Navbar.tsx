      ...
      <div className={cn(
        ...
        <div className={cn(
          ...
          <div className="flex items-center gap-2">
            ...
            <Button onClick={() => go("admissions")} size="sm" className="bg-gold text-gold-foreground hover:opacity-90 hidden md:inline-flex">
              Apply Now
            </Button>
          ...
          {open && (
            ...
            >
              ...
              <div className="mt-3 flex gap-2">
                ...
                <Button onClick={() => go("admissions")} size="sm" className="flex-1 bg-gold text-gold-foreground">Apply Now</Button>
              </div>
            </motion.div>
          )}
        </AnimatePresence>
