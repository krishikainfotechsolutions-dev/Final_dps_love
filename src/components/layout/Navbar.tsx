        ...
        <div className={cn(
          ...
          <div className="flex items-center gap-2">
            <Button asChild size="sm" variant="outline" className="hidden md:inline-flex border-primary/30 text-primary hover:bg-primary hover:text-primary-foreground">
              <Link to="/admin/login"><Shield className="w-4 h-4" /> Admin</Link>
            </Button>
          ...
          {open && (
            ...
            >
              ...
              <div className="mt-3 flex gap-2">
                <Button asChild size="sm" variant="outline" className="flex-1 border-primary/30 text-primary"><Link to="/admin/login">Admin</Link></Button>
