...
import {
  seedNotices, seedEvents, seedStaff, seedGallery, seedToppers, seedKeyDates, seedAwards,
} from "@/lib/seed";
...
const collections = ["notices", "events", "staff", "gallery", "toppers", "keyDates", "awards"] as const;

export function ContentProvider({ children }: { children: ReactNode }) {
  const [data, setData] = useState<Record<string, any[]>>({
    notices: seedNotices, events: seedEvents, staff: seedStaff,
    gallery: seedGallery, toppers: seedToppers, keyDates: seedKeyDates, awards: seedAwards,
  });
