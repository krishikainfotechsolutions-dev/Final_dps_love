...
import {
  ...
  Plus, Pencil, Trash2, X, Save, Pin, ChevronLeft, Upload, Loader2
} from "lucide-react";
                  ...
                  <div className="space-y-1">
                    ...
                    {isImageField && (
                      <label className="flex items-center gap-2 cursor-pointer text-xs text-primary hover:underline">
                        ...
                        <input type="file" accept="image/*" className="hidden" onChange={(e) => handleImageUpload(e, f.key)} disabled={uploading} />
                      </label>
                    )}
