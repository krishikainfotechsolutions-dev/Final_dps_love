...
export const SCHOOL = {
  ...
  affiliation: "Uttar Pradesh Madhyamik Shiksha Parishad (UPMSP)",
};

export const seedNotices = [
  { id: "n1", title: "Annual Result Declaration 2025", body: "Class 10 & 12 UP Board results will be declared on May 13, 2025. Parents are invited to attend the ceremony.", date: "2025-05-10", pinned: true, link: "" },
  { id: "n2", title: "Summer Vacation Notice", body: "School will remain closed for summer break from May 25 to June 30. Reopens July 1.", date: "2025-05-20", pinned: false, link: "" },
  { id: "n3", title: "Admission Open 2025-26", body: "Admissions for Nursery to Class 9 are now open. Limited seats available. Contact the school office for details.", date: "2025-04-01", pinned: true, link: "" },
  { id: "n4", title: "Parent-Teacher Meeting", body: "PTM scheduled for the second Saturday of every month from 10 AM to 1 PM.", date: "2025-04-12", pinned: false, link: "" },
  { id: "n5", title: "New Smart Classrooms", body: "Smart classrooms with interactive panels installed across all sections.", date: "2025-03-15", pinned: false, link: "" },
  { id: "n6", title: "Sports Trials Announcement", body: "Trials for the inter-school cricket and athletics teams begin next week.", date: "2025-03-08", pinned: false, link: "" },
];
...
export const seedStaff = [
  { id: "s1", name: "Dr. Anjali Sharma", role: "Principal", subjects: ["Leadership"], bio: "20+ years of experience leading premier UP Board institutions across North India.", photo: "https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=400&q=80" },
  ...
  { id: "s4", name: "Mr. Suresh Tiwari", role: "Science HOD", subjects: ["Physics", "Chemistry"], bio: "Leading our STEM curriculum with inquiry-based learning aligned to UP Board syllabus.", photo: "https://images.unsplash.com/photo-1612349317150-e413f6a5b16d?w=400&q=80" },
  ...
  { id: "s7", name: "Mrs. Sunita Yadav", role: "Hindi HOD", subjects: ["Hindi", "Sanskrit"], bio: "Sahitya Ratna with a love for classical Hindi literature and UP Board curriculum.", photo: "https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=400&q=80" },
  { id: "s8", name: "Mr. Deepak Joshi", role: "Maths Faculty", subjects: ["Mathematics"], bio: "Experienced Mathematics teacher with strong command of UP Board exam patterns.", photo: "https://images.unsplash.com/photo-1568602471122-7832951cc4c5?w=400&q=80" },
  { id: "s9", name: "Ms. Neha Kapoor", role: "Biology Faculty", subjects: ["Biology"], bio: "UP Board Biology specialist with 12 years of teaching experience.", photo: "https://images.unsplash.com/photo-1551836022-d5d88e9218df?w=400&q=80" },
  ...
  { id: "s11", name: "Mrs. Pooja Bhatt", role: "Pre-Primary Head", subjects: ["Early Childhood"], bio: "Specialist in play-based and Montessori learning for young children.", photo: "https://images.unsplash.com/photo-1487412720507-e7ab37603c6f?w=400&q=80" },
  { id: "s12", name: "Mr. Ramesh Dubey", role: "Social Science", subjects: ["History", "Civics"], bio: "Storyteller bringing UP Board History and Civics alive in the classroom.", photo: "https://images.unsplash.com/photo-1492562080023-ab3db95bfbce?w=400&q=80" },
  ...
  { id: "s16", name: "Mr. Prakash Trivedi", role: "Physics Faculty", subjects: ["Physics"], bio: "Senior Physics teacher with 18 years of UP Board teaching experience.", photo: "https://images.unsplash.com/photo-1542178243-bc20204b769f?w=400&q=80" },
  { id: "s17", name: "Mrs. Aarti Chauhan", role: "Chemistry Faculty", subjects: ["Chemistry"], bio: "PhD in Organic Chemistry, experienced UP Board Chemistry mentor.", photo: "https://images.unsplash.com/photo-1607746882042-944635dfe10e?w=400&q=80" },
  { id: "s18", name: "Mr. Sanjay Rastogi", role: "Economics", subjects: ["Economics"], bio: "Bringing real-world markets into the UP Board Economics classroom.", photo: "https://images.unsplash.com/photo-1559548331-f9cb98001426?w=400&q=80" },
  ...
  { id: "s22", name: "Mr. Tarun Chand", role: "IT Coordinator", subjects: ["Computer Science"], bio: "Robotics and digital lab in-charge.", photo: "https://images.unsplash.com/photo-1519345182560-3f2917c472ef?w=400&q=80" },
];
...
export const seedToppers = [
  { id: "t1", name: "Aarav Sharma", class: "Class XII Science", year: "2024", percentage: 98.4, rank: 1, photo: "https://images.unsplash.com/photo-1531123897727-8f129e1688ce?w=400&q=80" },
  { id: "t2", name: "Saanvi Tripathi", class: "Class XII Commerce", year: "2024", percentage: 97.8, rank: 2, photo: "https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=400&q=80" },
  { id: "t3", name: "Rohan Mishra", class: "Class X", year: "2024", percentage: 97.2, rank: 1, photo: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=400&q=80" },
  { id: "t4", name: "Ishita Agarwal", class: "Class XII Science", year: "2024", percentage: 96.6, rank: 3, photo: "https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=400&q=80" },
  { id: "t5", name: "Aryan Verma", class: "Class X", year: "2024", percentage: 96.0, rank: 2, photo: "https://images.unsplash.com/photo-1502720705749-871143f0e671?w=400&q=80" },
  { id: "t6", name: "Diya Pandey", class: "Class XII Commerce", year: "2024", percentage: 95.8, rank: 3, photo: "https://images.unsplash.com/photo-1521252659862-eec69941b071?w=400&q=80" },
];

export const seedKeyDates = [
  { id: "k1", title: "Session Begins", date: "2025-04-01", description: "Academic session 2025-26 begins for all classes.", type: "Academic", link: "" },
  { id: "k2", title: "First Unit Test", date: "2025-05-15", description: "Cycle test for Classes V–XII as per UP Board schedule.", type: "Exam", link: "" },
  { id: "k3", title: "Summer Break", date: "2025-05-25", description: "School closed till June 30.", type: "Holiday", link: "" },
  { id: "k4", title: "Independence Day", date: "2025-08-15", description: "Flag hoisting and cultural programme.", type: "Event", link: "" },
  { id: "k5", title: "Half-Yearly Exams", date: "2025-09-20", description: "Half-yearly assessment for all senior classes.", type: "Exam", link: "" },
  { id: "k6", title: "Annual Day", date: "2025-12-18", description: "Annual cultural function and prize distribution.", type: "Event", link: "" },
  { id: "k7", title: "Pre-Board Exams", date: "2026-01-10", description: "Pre-board examinations for Classes 10 and 12.", type: "Exam", link: "" },
  { id: "k8", title: "UP Board Result Declaration", date: "2026-03-30", description: "Annual UP Board results declared.", type: "Academic", link: "" },
];
...
export const seedAwards = [
  ...
  { id: "a6", title: "100% UP Board Pass Rate", year: "2024", description: "UP Board Class 10 & 12 — Outstanding Results" },
];
